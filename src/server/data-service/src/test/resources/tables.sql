...
--changeset Izentall:create-architectures-table
...
--changeset Izentall:create-gpus-table
CREATE TABLE gpus
(
    id serial PRIMARY KEY,
...
--changeset Izentall:create-shops-table
CREATE TABLE shops
(
    id serial PRIMARY KEY,
...
--changeset Izentall:create-vendors-table
...
--changeset Izentall:create-offers-table
CREATE TABLE offers
(
